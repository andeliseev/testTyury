...
`);function Dh(n){const t=Ko[n],e=t.length;let r=kh,i="";const s="finalColor += texture(uTexture, vBlurTexCoords[%index%]) * %value%;";let o;for(let a=0;a<n;a++){let l=s.replace("%index%",a.toString());o=a,a>=e&&(o=n-a-1),l=l.replace("%value%",t[o].toString()),i+=l,i+=`
`}return r=r.replace("%blur%",i),r=r.replace("%size%",n.toString()),r}const Eh=`
    in vec2 aPosition;
    ...
    vec4 filterVertexPosition( void )
{
    ...
    void main(void)
    {
        ...
        %blur%
    }`;function Lh(n,t){const e=Math.ceil(n/2);let r=Eh,i="",s;t?s="vBlurTexCoords[%index%] =  textureCoord + vec2(%sampleIndex% * pixelStrength, 0.0);":s="vBlurTexCoords[%index%] =  textureCoord + vec2(0.0, %sampleIndex% * pixelStrength);";for(let o=0;o<n;o++){let a=s.replace("%index%",o.toString());a=a.replace("%sampleIndex%",`${o-(e-1)}.0`),i+=a,i+=`
`}return r=r.replace("%blur%",i),r=r.replace("%size%",n.toString()),r=r.replace("%dimension%",t?"z":"w"),r}function Gh(n,t){const e=Lh(t,n),r=Dh(t);return N.from({vertex:e,fragment:r,name:`blur-${n?"horizontal":"vertical"}-pass-filter`})}var Nh=`
...
const DOUBLE_PI: f32 = 3.14159265358979323846264 * 2.;`,Km=Object.defineProperty,Zm=(n,t,e)=>t in n?Km(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,se=(n,t,e)=>(Zm(n,typeof t!="symbol"?t+"":t,e),e);const wi=class re extends ${constructor(...t){let e=t[0]??{};typeof e=="number"&&(U("6.0.0","OutlineFilter constructor params are now options object. See params: { thickness, color, quality, alpha, knockout }"),e={thickness:e},t[1]!==void 0&&(e.color=t[1]),t[2]!==void 0&&(e.quality=t[2]),t[3]!==void 0&&(e.alpha=t[3]),t[4]!==void 0&&(e.knockout=t[4])),e={...re.DEFAULT_OPTIONS,...e};const r=e.quality??.1,i=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:qm,entryPoint:"mainFragment"}}),s=N.from({vertex:W,fragment:jm.replace(/\$\{ANGLE_STEP\}/,re.getAngleStep(r).toFixed(7)),name:"outline-filter"});super({gpuProgram:i,glProgram:s,resources:{outlineUniforms:{uThickness:{value:new Float32Array(2),type:"vec2<f32>"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"},uAngleStep:{value:0,type:"f32"},uKnockout:{value:e.knockout?1:0,type:"f32"}}}}),se(this,"uniforms"),se(this,"_thickness"),se(this,"_quality"),se(this,"_color"),this.uniforms=this.resources.outlineUniforms.uniforms,this.uniforms.uAngleStep=re.getAngleStep(r),this._color=new j,this.color=e.color??0,Object.assign(this,e)}apply(t,e,r,i){this.uniforms.uThickness[0]=this.thickness/e.source.width,this.uniforms.uThickness[1]=this.thickness/e.source.height,t.applyFilter(this,e,r,i)}static getAngleStep(t){return parseFloat((Math.PI*2/Math.max(t*re.MAX_SAMPLES,re.MIN_SAMPLES)).toFixed(7))}get thickness(){return this._thickness}set thickness(t){this._thickness=this.padding=t}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,r,i]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=r,this.uniforms.uColor[2]=i}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}get quality(){return this._quality}set quality(t){this._quality=t,this.uniforms.uAngleStep=re.getAngleStep(t)}get knockout(){return this.uniforms.uKnockout===1}set knockout(t){this.uniforms.uKnockout=t?1:0}};se(wi,"DEFAULT_OPTIONS",{thickness:1,color:0,alpha:1,quality:.1,knockout:!1});se(wi,"MIN_SAMPLES",1);se(wi,"MAX_SAMPLES",100);var Qm=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,Dp=Object.defineProperty,Ep=(n,t,e)=>t in n?Dp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ha=(n,t,e)=>(Ep(n,typeof t!="symbol"?t+"":t,e),e);const Lp=class ja extends ${constructor(t){t={...ja.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,r=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:kp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),i=N.from({vertex:W,fragment:Bp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ha(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};Ha(Lp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});const Ye=20;class Gp extends Z{constructor(){super();b(this,"bg");b(this,"model");b(this,"hand");b(this,"beard");b(this,"tattoo");b(this,"zones");b(this,"tattoos",[]);b(this,"isShown",!1);b(this,"text");this.bg=new et({texture:I.from("komnata1")}),this.bg.scale=.5,this.bg.x=-this.bg.width/2+T.width/2,this.bg.y=T.topPos+Ye,this.addChild(this.bg);const e=new et({texture:I.from("box")});e.scale=.7,e.x=-e.width/2+T.width/2,e.y=T.bottomPos-e.height-Ye,e.eventMode="static",e.cursor="pointer";const r=a=>{this.isShown=!this.isShown;for(let l=0;l<this.tattoos.length;l++)this.tattoos[l].visible=this.isShown};e.on("pointerdown",r),this.addChild(e),this.model=new et({texture:I.from("model1")}),this.model.scale=.5,this.model.x=-this.model.width/2+T.width/2,this.model.y=T.topPos+Ye+10,this.addChild(this.model),this.hand=new et({texture:I.from("hand")}),this.hand.anchor.x=.9,this.hand.anchor.y=.09,this.hand.x=366,this.hand.y=488,this.model.addChild(this.hand);const i=(a,l)=>{l.alpha==0?l.alpha=.5:l.alpha==.5?(l.filters[0].size=3,l.alpha=.75):l.alpha==.75?(l.filters[0].size=1.5,l.alpha=.85):l.alpha==.85?(l.filters[0].size=1,l.alpha=.95):l.alpha==.95?(l.filters=[],l.alpha=1):l.alpha==1&&(l.filters=[new Rs(5)],l.alpha=0),l.visible=l.alpha>0},s=(a,l,c,u)=>{const h=new et({texture:I.from(a+"Zone")}),f=!1;h.hitArea=new _e(l),h.eventMode="static",h.cursor="pointer",h.alpha=0,h.scale=2,h.x=u[0]*2,h.y=u[1]*2,this.model.addChild(h);const d=new et({texture:I.from(a+"0")});d.scale=2,d.x=(u[0]+c[0])*2,d.y=(u[1]+c[1])*2,d.visible=f,this.model.addChild(d),d.filters=[new Rs(5)],d.alpha=0,this.tattoos.push(d),h.on("pointerdown",m=>i(m,d))};s("leftArmTop",[0,45,80,0,96,35,35,60],[5,-1],[2,80]),s("leftArmBottom",[-5,2,35,20,40,85,22,100],[1,-3],[0,126]),s("rightArmTop",[-5,2,35,10,55,110,20,80],[1,2],[212,118]),s("RightArmBottom",[0,36,65,0,85,25,16,55],[11,-1],[172,204]),s("RightLegTop",[0,26,10,0,45,20,25,50],[5,2],[250,230]),s("RightLegBottom",[0,96,55,0,92,25,25,105],[21,4],[183,260]),s("LeftLegTop",[0,10,25,5,35,40,10,55],[-2,1],[10,230]),s("LeftLegBottom",[90,105,40,5,0,30,55,105],[1,0],[23,260]),s("LeftShoulder",[2,10,45,0,55,20,12,30],[5,0],[80,66]),s("RightShoulder",[0,0,30,5,55,40,15,30],[1,-2],[194,86]),s("Middle",[20,-15,110,0,115,55,10,45],[4,-49],[90,112]);const o=new et({texture:I.from("reflection")});this.model.addChild(o),this.beard=new et({texture:I.from("beard")}),this.beard.x=274,this.beard.y=-2,this.model.addChild(this.beard)}update(e){this.hand.rotation=Lt(0,-.12,Math.sin(e.lastTime*.004))}}class G{constructor(t,e,r){b(this,"x");b(this,"y");b(this,"z");this.x=t,this.y=e,this.z=r}clone(){return new G(this.x,this.y,this.z)}size(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalize(){const t=this.size();return t==0?this:(this.x/=t,this.y/=t,this.z/=t,this)}add(t){return new G(this.x+t.x,this.y+t.y,this.z+t.z)}mul(t){return new G(this.x*t,this.y*t,this.z*t)}cross(t){return new G(this.y*t.z-this.z*t.y,this.z*t.x-this.x*t.z,this.x*t.y-this.y*t.x)}dot(t){return this.x*t.x+this.y*t.y+this.z*t.z}rotateX(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x,this.y*r-this.z*e,this.y*e+this.z*r)}rotateY(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x*r+this.z*e,this.y,-this.x*e+this.z*r)}rotateZ(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x*r-this.y*e,this.x*e+this.y*r,this.z)}}class we{constructor(t){b(this,"m");this.m=t}static fromOrientationVectors(t,e){const r=t.cross(e);return new we([[t.x,e.x,r.x],[t.y,e.y,r.y],[t.z,e.z,r.z]])}transpose(){const t=this.m;return new we([[t[0][0],t[1][0],t[2][0]],[t[0][1],t[1][1],t[2][1]],[t[0][2],t[1][2],t[2][2]]])}multiply(t){const e=[];for(let r=0;r<3;r++){e[r]=[];for(let i=0;i<3;i++){e[r][i]=0;for(let s=0;s<3;s++)e[r][i]+=this.m[r][s]*t.m[s][i]}}return new we(e)}multiplyVector(t){const e=this.m[0][0]*t.x+this.m[0][1]*t.y+this.m[0][2]*t.z,r=this.m[1][0]*t.x+this.m[1][1]*t.y+this.m[1][2]*t.z,i=this.m[2][0]*t.x+this.m[2][1]*t.y+this.m[2][2]*t.z;return new G(e,r,i)}}const zr=50,yn=150,_n=15,de=12;class Np{constructor(){b(this,"x",0);b(this,"y",0);b(this,"z",0);b(this,"vx",0);b(this,"vy",0);b(this,"vz",0);b(this,"va",new G(0,0,0));b(this,"oldX",0);b(this,"oldY",0);b(this,"oldZ",0);b(this,"oldVZ",0);b(this,"oldVAsize",0)}}class $p{constructor(){b(this,"vecX");b(this,"vecY");b(this,"x");b(this,"y");b(this,"z")}}class Mr extends et{constructor(e,r,i,s){super();b(this,"spriteX",0);b(this,"spriteY",4);b(this,"vecX",new G(1,0,0));b(this,"vecY",new G(0,1,0));b(this,"physicsData");b(this,"diceTexture");b(this,"shadow");b(this,"needPlayback",!1);b(this,"recordedData",[]);b(this,"needFinalOffset",!1);b(this,"randomAngle",0);this.physicsData=new Np,this.physicsData.x=e,this.physicsData.y=r,this.physicsData.oldX=e,this.physicsData.oldY=r,this.diceTexture=i,this.shadow=new et({texture:s}),this.shadow.x=this.physicsData.x,this.shadow.y=this.physicsData.y,this.shadow.blendMode="multiply",this.shadow.alpha=.8;const o=this.getRandomFaceIndex();this.needFinalOffset=o==2;const a=this.getFaceOrientation(o);this.vecX=a[0],this.vecY=a[1],this.roundPixels=!0,this.anchor.set(.5),this.CalculateSpriteFaceAndAngle()}getRandomFaceIndex(){return Is(0,6)}getFaceOrientation(e){return e==0?[new G(1,0,0),new G(0,1,0)]:e==1?[new G(0,0,1),new G(0,1,0)]:e==2?[new G(1,0,0),new G(0,0,1)]:e==3?[new G(1,0,0),new G(0,0,-1)]:e==4?[new G(0,0,-1),new G(0,1,0)]:[new G(-1,0,0),new G(0,1,0)]}Rotate(e,r){if(r==0)return;let i,s,o;const a=e.clone().normalize(),l=new G(e.x,e.y,0).normalize();i=Math.acos(l.x),l.y<0&&(i=-i),s=a.z==0?0:a.z>0?Math.PI/2:-Math.PI/2,o=Math.acos(Math.min(Math.max(a.dot(l),-1),1)),this.vecX=this.vecX.rotateZ(-i).rotateX(-s).rotateZ(-o),this.vecX=this.vecX.rotateX(r),this.vecX=this.vecX.rotateZ(o).rotateX(s).rotateZ(i),this.vecY=this.vecY.rotateZ(-i).rotateX(-s).rotateZ(-o),this.vecY=this.vecY.rotateX(r),this.vecY=this.vecY.rotateZ(o).rotateX(s).rotateZ(i),this.vecX.normalize(),this.vecY.normalize()}Stabilize(){let e=new G(this.vecX.x,this.vecX.y,0);Math.abs(this.vecX.z)<=e.size()?this.vecX=e.normalize():this.vecX=new G(0,0,this.vecX.z>0?1:-1),e=new G(this.vecY.x,this.vecY.y,0),Math.abs(this.vecY.z)<=e.size()&&Math.abs(e.dot(this.vecX))<.01||this.vecX.z!=0?this.vecY=e.normalize():this.vecY=new G(0,0,this.vecY.z>0?1:-1)}AddImpact(e,r){const i=this.getRandomFaceIndex(),s=this.getFaceOrientation(i);this.vecX=s[0],this.vecY=s[1],e?this.physicsData.vz=Lt(2,3,Math.random()):this.physicsData.vz=Lt(.5,1,Math.random()),this.physicsData.vy=Math.random()>.5?Lt(-10,-50,Math.random()):Lt(10,50,Math.random());let o=Lt(-5,5,Math.random()),a=Lt(-5,5,Math.random());this.physicsData.va=new G(o,a,Math.random()),this.recordedData=[];let l=!1;for(;!l;){this.CalculatePhysics();let c=new $p;if(c.vecX=this.vecX,c.vecY=this.vecY,c.x=this.physicsData.x,c.y=this.physicsData.y,c.z=this.physicsData.z,this.recordedData.push(c),this.physicsData.vx==0&&this.physicsData.vy==0&&this.physicsData.vz==0&&this.physicsData.va.size()<.01){this.randomAngle=0,r==-1&&(r=Is(0,6)),this.needFinalOffset=r==2,this.randomAngle=Lt(-40,40,Math.random());const[u,h]=this.getFaceOrientation(r),f=we.fromOrientationVectors(this.vecX,this.vecY),m=we.fromOrientationVectors(u,h).multiply(f.transpose());for(let g of this.recordedData)g.vecX=m.multiplyVector(g.vecX).normalize(),g.vecY=m.multiplyVector(g.vecY).normalize();this.recordedData.reverse(),l=!0,this.needPlayback=!0}}}UpdateSpriteFace(e,r){const i=new at(e*yn,r*yn,yn,yn);this.texture=new I({source:this.diceTexture.source,frame:i})}CalculatePhysics(){const e=this.vecX.cross(this.vecY);for(let l=-1;l<=1;l+=2)for(let c=-1;c<=1;c+=2)for(let u=-1;u<=1;u+=2){const h=new G(l*this.vecX.x+c*this.vecY.x+u*e.x,l*this.vecX.y+c*this.vecY.y+u*e.y,l*this.vecX.z+c*this.vecY.z+u*e.z);if(this.physicsData.z+h.z<-1){let f=h.cross(new G(0,0,1));f.normalize(),f=f.mul((Math.max(0,-this.physicsData.vz)+Math.max(0,this.physicsData.va.dot(f.mul(-1))))*.5+.1),this.physicsData.va=this.physicsData.va.add(f),this.physicsData.z=-1-h.z}}this.Rotate(this.physicsData.va,this.physicsData.va.size()/10),this.physicsData.z>10&&(this.physicsData.z=10),this.physicsData.z>0&&(this.physicsData.vz-=.16),this.physicsData.x+=this.physicsData.vx,this.physicsData.y+=this.physicsData.vy,this.physicsData.z+=this.physicsData.vz;const r=Math.min(Ge(this.physicsData.z,0,4,zr/1.5,zr),zr),i=T.topPos+38+r,s=T.topPos+38+376-r,o=T.width/2-340/2+r,a=T.width/2-340/2+340-r;this.physicsData.x<o&&(this.physicsData.x=o,this.physicsData.vx<0&&(this.physicsData.vx=-this.physicsData.vx*.5)),this.physicsData.x>a&&(this.physicsData.x=a,this.physicsData.vx>0&&(this.physicsData.vx=-this.physicsData.vx*.5)),this.physicsData.y<i&&(this.physicsData.y=i,this.physicsData.vy<0&&(this.physicsData.vy=-this.physicsData.vy*.5)),this.physicsData.y>s&&(this.physicsData.y=s,this.physicsData.vy>0&&(this.physicsData.vy=-this.physicsData.vy*.5)),this.physicsData.z<=.01&&(this.physicsData.z=0,this.physicsData.vx*=.5,Math.abs(this.physicsData.vx)<.01&&(this.physicsData.vx=0),this.physicsData.vy*=.5,Math.abs(this.physicsData.vy)<.01&&(this.physicsData.vy=0),this.physicsData.vz*=.5,Math.abs(this.physicsData.vz)<.01&&(this.physicsData.vz=0),this.physicsData.va=new G(0,0,0),this.Stabilize()),this.physicsData.oldZ<.5&&this.physicsData.z<.5&&(this.physicsData.z=0),Math.abs(this.physicsData.oldVZ)<.5&&Math.abs(this.physicsData.vz)<.5&&(this.physicsData.vz=0),this.physicsData.z==0&&this.physicsData.oldVAsize<.4&&this.physicsData.va.size()<.4&&(this.physicsData.va=new G(0,0,0),this.Stabilize()),this.physicsData.oldZ=this.physicsData.z,this.physicsData.oldVZ=this.physicsData.vz,this.physicsData.oldVAsize=this.physicsData.va.size()}GetCurrentFace(){return this.spriteX==0&&this.spriteY==6?1:this.spriteX==6&&this.spriteY==6?2:this.spriteX==0&&this.spriteY==12?3:this.spriteX==0&&this.spriteY==0?4:this.spriteX==18&&this.spriteY==6?5:this.spriteX==12&&this.spriteY==6?6:-1}CalculateSpriteFaceAndAngle(){let e=0,r,i,s,o,a,l,c;r=Math.asin(this.vecY.z)*180/Math.PI,a=new G(this.vecY.x,this.vecY.y,0),a.normalize(),s=Math.acos(a.y)*180/Math.PI,a.x>0&&(s=-s),c=a.y,l=Math.sin(s*Math.PI/180),o=new G(this.vecX.x*c+this.vecX.y*l,-this.vecX.x*l+this.vecX.y*c,this.vecX.z),l=this.vecY.z,c=Math.sqrt(1-l*l),o=new G(o.x,o.y*c+o.z*l,-o.y*l+o.z*c),i=Math.acos(o.x)*180/Math.PI,o.z>0&&(i=-i),this.spriteY=Math.round(r/_n)+de/2,this.spriteX=(Math.round(-(i-180)/_n)+de)%(de*2),(this.spriteY==0||this.spriteY==de)&&(this.spriteX=0),this.spriteY==0&&(e=i),this.spriteY==de&&(i<0&&(e=180),this.needFinalOffset&&(e-=90)),e-=s,e+=this.randomAngle,this.spriteY!=0&&this.spriteY!=de&&(e=Math.round(e/_n)*_n),this.angle=e,this.Draw()}Draw(){this.x=this.physicsData.x,this.y=this.physicsData.y,this.physicsData.z>2?(this.scale=Ge(this.physicsData.z,2,10,.7,.9),this.shadow.scale=Ge(this.physicsData.z,2,10,2,2.6)):(this.scale=Ge(this.physicsData.z,0,2,.5,.7),this.shadow.scale=Ge(this.physicsData.z,0,2,1.4,2)),this.shadow.x=this.x-this.width+this.physicsData.z*4-4,this.shadow.y=this.y-this.height+this.physicsData.z*4-4,this.zIndex=this.physicsData.z,this.UpdateSpriteFace(this.spriteX,this.spriteY)}SkipPlayback(){if(this.needPlayback&&this.recordedData.length>0){const e=this.recordedData[0];this.vecX=e.vecX,this.vecY=e.vecY,this.physicsData.x=e.x,this.physicsData.y=e.y,this.physicsData.z=e.z,this.CalculateSpriteFaceAndAngle(),this.needPlayback=!1}}Update(){if(this.needPlayback){const e=this.recordedData.pop();e!=null?(this.vecX=e.vecX,this.vecY=e.vecY,this.physicsData.x=e.x,this.physicsData.y=e.y,this.physicsData.z=e.z,this.CalculateSpriteFaceAndAngle()):this.needPlayback=!1}}}class Vp extends Z{constructor(){super();b(this,"boxContainer");b(this,"bg");b(this,"dice");b(this,"dice2");b(this,"dice3");b(this,"randomBtn");b(this,"shake");b(this,"energyText");this.bg=new et({texture:I.from("floor")}),this.bg.scale=.7,this.bg.x=-this.bg.width/2+T.width/2,this.bg.y=T.bottomPos-this.bg.height,this.addChild(this.bg),this.boxContainer=new Z,this.addChild(this.boxContainer),this.bg=new et({texture:I.from("diceBackground")}),this.bg.scale=.6,this.bg.x=-this.bg.width/2+T.width/2,this.bg.y=T.topPos+Ye,this.boxContainer.addChild(this.bg);const e=new et({texture:I.from("wood")});e.scale=.5,e.x=-e.width/2+T.width/2,e.y=T.topPos,e.zIndex=0,this.boxContainer.addChild(e);const r=new Ut().rect(T.width/2-350/2,T.topPos+38,350,380).fill("#df6c6c");this.boxContainer.addChild(r),this.bg.mask=r,this.energyText=$t(this.ourEnergyText),this.energyText.x=T.width/2,this.energyText.y=T.topPos+432,this.energyText.style.fontSize=22,this.energyText.anchor.set(.5),this.boxContainer.addChild(this.energyText);let i=I.from("dice"),s=I.from("diceShadow");this.dice=new Mr(T.width/2-100,this.bg.y+330,i,s),this.dice2=new Mr(T.width/2+100,this.bg.y+330,i,s),this.dice3=new Mr(T.width/2,this.bg.y+330,i,s),this.boxContainer.addChild(this.dice.shadow),this.boxContainer.addChild(this.dice2.shadow),this.boxContainer.addChild(this.dice3.shadow),this.boxContainer.addChild(this.dice),this.boxContainer.addChild(this.dice2),this.boxContainer.addChild(this.dice3),this.dice.Draw(),this.dice2.Draw(),this.dice3.Draw();const o=T.topPos+38+382+40;this.randomBtn=new Kt({text:"Random",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2-this.randomBtn.width/2,this.randomBtn.y=o+(T.bottomPos-o)/2-this.randomBtn.height*2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(-1)),this.randomBtn=new Kt({text:"Sugar",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(T.bottomPos-o)/2-this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(0)),this.randomBtn=new Kt({text:"PVP",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2+2,this.randomBtn.y=o+(T.bottomPos-o)/2-this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(1)),this.randomBtn=new Kt({text:"Free",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(T.bottomPos-o)/2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(2)),this.randomBtn=new Kt({text:"Event",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2+2,this.randomBtn.y=o+(T.bottomPos-o)/2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(3)),this.randomBtn=new Kt({text:"Fight",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(T.bottomPos-o)/2+this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(4)),this.randomBtn=new Kt({text:"Jackpot",tint:"#9296A0"}),this.randomBtn.scale=1.9,this.randomBtn.x=T.width/2+2,this.randomBtn.y=o+(T.bottomPos-o)/2+this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(5))}get ourEnergyText(){return`Energy: ${zf(Je.data.energy)}/50`}SkipDicePlayback(){this.dice.SkipPlayback(),this.dice2.SkipPlayback(),this.dice3.SkipPlayback()}ThrowDiceButtonClick(e){!this.dice.needPlayback&&!this.dice2.needPlayback&&!this.dice3.needPlayback?Ze.ThrowDice(Je.data)&&this.ThrowDices(e):this.SkipDicePlayback()}ThrowDices(e){let r=!1;Math.random()>.8&&(r=!0),this.dice.AddImpact(r,e),this.dice2.AddImpact(r,e),this.dice3.AddImpact(r,e)}update(e){this.dice.Update(),this.dice2.Update(),this.dice3.Update(),this.energyText.text=this.ourEnergyText}}const Bn=class Bn extends Z{constructor(){super();b(this,"roomScreen");b(this,"diceScreen");b(this,"backButton");b(this,"timer");b(this,"assetBundles",["diceAsset","uiAsset","background","fonts"]);b(this,"data");b(this,"orientationDisclaimer");b(this,"orientationDisclaimerText");this.data=Ze.LoadData(),Bn.data=this.data,screen.orientation.addEventListener("change",()=>{switch(screen.orientation.type){case"landscape-primary":this.orientationDisclaimerText.angle=90,this.orientationDisclaimer.visible=!0;break;case"landscape-secondary":this.orientationDisclaimerText.angle=-90,this.orientationDisclaimer.visible=!0;break;case"portrait-secondary":case"portrait-primary":default:this.orientationDisclaimer.visible=!1}})}constructorWithAssets(){this.roomScreen=new Gp,this.addChild(this.roomScreen),this.diceScreen=new Vp,this.addChild(this.diceScreen),this.roomScreen.visible=!1,this.diceScreen.visible=!0,this.backButton=new et({texture:I.from("roomIcon")}),this.backButton.scale=.5,this.backButton.x=T.rightPos-this.backButton.width-10,this.backButton.y=T.bottomPos-this.backButton.height-Ye,this.backButton.eventMode="static",this.backButton.cursor="pointer",this.backButton.on("pointerdown",()=>{this.flipScrens()}),this.addChild(this.backButton),this.orientationDisclaimer=new Ut().rect(0,0,T.width,T.height).fill(1),this.addChild(this.orientationDisclaimer),this.orientationDisclaimerText=$t("Ну переверни!"),this.orientationDisclaimerText.style.fontSize=30,this.orientationDisclaimerText.anchor.set(.5),this.orientationDisclaimerText.x=T.width/2,this.orientationDisclaimerText.y=T.height/2,this.orientationDisclaimer.addChild(this.orientationDisclaimerText),this.orientationDisclaimer.visible=!1}flipScrens(){this.roomScreen.visible=!this.roomScreen.visible,this.diceScreen.visible=!this.diceScreen.visible}update(e){this.roomScreen.update(e),this.roomScreen.y=0,this.diceScreen.update(e)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),i=$t(e+"x"+r);i.anchor.set(.5),i.x=T.width/2,i.y=T.width/2-10,this.addChild(i);const s=$t(T.enlargedWidth+"x"+T.enlargedHeight);s.anchor.set(.5),s.x=T.width/2,s.y=T.width/2,this.addChild(s);const o=$t(window.Telegram.WebApp.platform);o.anchor.set(.5),o.x=T.width/2,o.y=T.width/2+10,this.addChild(o)}};b(Bn,"data");let Je=Bn;class Wp extends Z{constructor(){super();b(this,"assetBundles",["fonts"])}constructorWithAssets(){const e=$t("Играй на телефоне бро!");e.style.fontSize=30,e.anchor.set(.5),e.x=T.width/2,e.y=T.height/2,this.addChild(e)}update(e){}}let Xp=750,qa=100;Ke.isDesktop&&(qa=0);let si;const Yp=n=>{si=n.touches[0].clientY},Us=document.getElementsByTagName("body")[0],Hp=n=>{if(Us){const t=Us.scrollTop,e=n.changedTouches[0].clientY;t<=0&&si!==void 0&&si<e,n.preventDefault()}};document.documentElement.addEventListener("touchstart",Yp,{passive:!1});document.documentElement.addEventListener("touchmove",Hp,{passive:!1});(async()=>(await T.Init(550,Xp,1,qa),Ke.isMobile||Ke.isDev?await T.ChangeScene(new Je):await T.ChangeScene(new Wp)))();export{Q as $,Ao as A,rt as B,Z as C,lt as D,E,$ as F,L as G,Ct as H,Ni as I,et as J,uu as K,_u as L,H as M,it as N,at as O,ut as P,Eu as Q,Un as R,vu as S,un as T,go as U,Wi as V,Ll as W,rr as X,j as Y,Hs as Z,U as _,Br as a,Fo as a0,Te as a1,hh as a2,Vo as a3,Hh as a4,jh as a5,ze as a6,ft as a7,na as a8,qh as a9,ko as aa,fe as ab,Vh as ac,le as ad,At as ae,Yi as af,Ut as ag,ml as ah,Eo as ai,Tt as b,N as c,ci as d,gt as e,fs as f,Tc as g,Mc as h,lr as i,Vt as j,Sn as k,ui as l,Io as m,Fi as n,So as o,ro as p,Pt as q,Al as r,I as s,dl as t,Fc as u,Ac as v,ct as w,Ot as x,Xs as y,pt as z};
