...
`;let Fe=null,er=class{constructor(){Fe||(Fe=URL.createObjectURL(new Blob([Mc],{type:"application/javascript"}))),this.worker=new Worker(Fe)}};er.revokeObjectURL=function(){Fe&&(URL.revokeObjectURL(Fe),Fe=null)};const Fc=`(function () {
    'use strict';
