...
`;let _e=null,jr=class{constructor(){_e||(_e=URL.createObjectURL(new Blob([vh],{type:"application/javascript"}))),this.worker=new Worker(_e)}};jr.revokeObjectURL=function(){_e&&(URL.revokeObjectURL(_e),_e=null)};const yh=`(function () {
    'use strict';
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,Ep=Object.defineProperty,Dp=(n,t,e)=>t in n?Ep(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ha=(n,t,e)=>(Dp(n,typeof t!="symbol"?t+"":t,e),e);const Lp=class ja extends ${constructor(t){t={...ja.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,r=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:kp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),i=N.from({vertex:W,fragment:Bp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ha(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};Ha(Lp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});const Xe=20;class Gp extends Q{constructor(){super();S(this,"bg");S(this,"model");S(this,"hand");S(this,"beard");S(this,"tattoo");S(this,"zones");S(this,"tattoos",[]);S(this,"isShown",!1);S(this,"text");this.bg=new et({texture:F.from("komnata1")}),this.bg.scale=.5,this.bg.x=-this.bg.width/2+R.width/2,this.bg.y=R.topPos+Xe,this.addChild(this.bg);const e=new et({texture:F.from("box")});e.scale=.7,e.x=-e.width/2+R.width/2,e.y=R.bottomPos-e.height-Xe,e.eventMode="static",e.cursor="pointer";const r=a=>{this.isShown=!this.isShown;for(let l=0;l<this.tattoos.length;l++)this.tattoos[l].visible=this.isShown};e.on("pointerdown",r),this.addChild(e),this.model=new et({texture:F.from("model1")}),this.model.scale=.5,this.model.x=-this.model.width/2+R.width/2,this.model.y=R.topPos+Xe+10,this.addChild(this.model),this.hand=new et({texture:F.from("hand")}),this.hand.anchor.x=.9,this.hand.anchor.y=.09,this.hand.x=366,this.hand.y=488,this.model.addChild(this.hand);const i=(a,l)=>{l.alpha==0?l.alpha=.5:l.alpha==.5?(l.filters[0].size=3,l.alpha=.75):l.alpha==.75?(l.filters[0].size=1.5,l.alpha=.85):l.alpha==.85?(l.filters[0].size=1,l.alpha=.95):l.alpha==.95?(l.filters=[],l.alpha=1):l.alpha==1&&(l.filters=[new Rs(5)],l.alpha=0),l.visible=l.alpha>0},s=(a,l,c,u)=>{const h=new et({texture:F.from(a+"Zone")}),f=!1;h.hitArea=new ye(l),h.eventMode="static",h.cursor="pointer",h.alpha=0,h.scale=2,h.x=u[0]*2,h.y=u[1]*2,this.model.addChild(h);const d=new et({texture:F.from(a+"0")});d.scale=2,d.x=(u[0]+c[0])*2,d.y=(u[1]+c[1])*2,d.visible=f,this.model.addChild(d),d.filters=[new Rs(5)],d.alpha=0,this.tattoos.push(d),h.on("pointerdown",m=>i(m,d))};s("leftArmTop",[0,45,80,0,96,35,35,60],[5,-1],[2,80]),s("leftArmBottom",[-5,2,35,20,40,85,22,100],[1,-3],[0,126]),s("rightArmTop",[-5,2,35,10,55,110,20,80],[1,2],[212,118]),s("RightArmBottom",[0,36,65,0,85,25,16,55],[11,-1],[172,204]),s("RightLegTop",[0,26,10,0,45,20,25,50],[5,2],[250,230]),s("RightLegBottom",[0,96,55,0,92,25,25,105],[21,4],[183,260]),s("LeftLegTop",[0,10,25,5,35,40,10,55],[-2,1],[10,230]),s("LeftLegBottom",[90,105,40,5,0,30,55,105],[1,0],[23,260]),s("LeftShoulder",[2,10,45,0,55,20,12,30],[5,0],[80,66]),s("RightShoulder",[0,0,30,5,55,40,15,30],[1,-2],[194,86]),s("Middle",[20,-15,110,0,115,55,10,45],[4,-49],[90,112]);const o=new et({texture:F.from("reflection")});this.model.addChild(o),this.beard=new et({texture:F.from("beard")}),this.beard.x=274,this.beard.y=-2,this.model.addChild(this.beard)}update(e){this.hand.rotation=Dt(0,-.12,Math.sin(e.lastTime*.004))}}class G{constructor(t,e,r){S(this,"x");S(this,"y");S(this,"z");this.x=t,this.y=e,this.z=r}clone(){return new G(this.x,this.y,this.z)}size(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}normalize(){const t=this.size();return t==0?this:(this.x/=t,this.y/=t,this.z/=t,this)}add(t){return new G(this.x+t.x,this.y+t.y,this.z+t.z)}mul(t){return new G(this.x*t,this.y*t,this.z*t)}cross(t){return new G(this.y*t.z-this.z*t.y,this.z*t.x-this.x*t.z,this.x*t.y-this.y*t.x)}dot(t){return this.x*t.x+this.y*t.y+this.z*t.z}rotateX(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x,this.y*r-this.z*e,this.y*e+this.z*r)}rotateY(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x*r+this.z*e,this.y,-this.x*e+this.z*r)}rotateZ(t){const e=Math.sin(t),r=Math.cos(t);return new G(this.x*r-this.y*e,this.x*e+this.y*r,this.z)}}class we{constructor(t){S(this,"m");this.m=t}static fromOrientationVectors(t,e){const r=t.cross(e);return new we([[t.x,e.x,r.x],[t.y,e.y,r.y],[t.z,e.z,r.z]])}transpose(){const t=this.m;return new we([[t[0][0],t[1][0],t[2][0]],[t[0][1],t[1][1],t[2][1]],[t[0][2],t[1][2],t[2][2]]])}multiply(t){const e=[];for(let r=0;r<3;r++){e[r]=[];for(let i=0;i<3;i++){e[r][i]=0;for(let s=0;s<3;s++)e[r][i]+=this.m[r][s]*t.m[s][i]}}return new we(e)}multiplyVector(t){const e=this.m[0][0]*t.x+this.m[0][1]*t.y+this.m[0][2]*t.z,r=this.m[1][0]*t.x+this.m[1][1]*t.y+this.m[1][2]*t.z,i=this.m[2][0]*t.x+this.m[2][1]*t.y+this.m[2][2]*t.z;return new G(e,r,i)}}const vn=50,yn=150,_n=15,fe=12;class Np{constructor(){S(this,"x",0);S(this,"y",0);S(this,"z",0);S(this,"vx",0);S(this,"vy",0);S(this,"vz",0);S(this,"va",new G(0,0,0));S(this,"oldX",0);S(this,"oldY",0);S(this,"oldZ",0);S(this,"oldVZ",0);S(this,"oldVAsize",0)}}class $p{constructor(){S(this,"vecX");S(this,"vecY");S(this,"x");S(this,"y");S(this,"z")}}class zr extends et{constructor(e,r,i,s){super();S(this,"spriteX",0);S(this,"spriteY",4);S(this,"vecX",new G(1,0,0));S(this,"vecY",new G(0,1,0));S(this,"physicsData");S(this,"diceTexture");S(this,"shadow");S(this,"needPlayback",!1);S(this,"recordedData",[]);S(this,"needFinalOffset",!1);S(this,"randomAngle",0);this.physicsData=new Np,this.physicsData.x=e,this.physicsData.y=r,this.physicsData.oldX=e,this.physicsData.oldY=r,this.diceTexture=i,this.shadow=new et({texture:s}),this.shadow.x=this.physicsData.x,this.shadow.y=this.physicsData.y,this.shadow.blendMode="multiply",this.shadow.alpha=.8;const o=this.getRandomFaceIndex();this.needFinalOffset=o==2;const a=this.getFaceOrientation(o);this.vecX=a[0],this.vecY=a[1],this.roundPixels=!0,this.anchor.set(.5),this.CalculateSpriteFaceAndAngle()}getRandomFaceIndex(){return Is(0,6)}getFaceOrientation(e){return e==0?[new G(1,0,0),new G(0,1,0)]:e==1?[new G(0,0,1),new G(0,1,0)]:e==2?[new G(1,0,0),new G(0,0,1)]:e==3?[new G(1,0,0),new G(0,0,-1)]:e==4?[new G(0,0,-1),new G(0,1,0)]:[new G(-1,0,0),new G(0,1,0)]}Rotate(e,r){if(r==0)return;let i,s,o;const a=e.clone().normalize(),l=new G(e.x,e.y,0).normalize();i=Math.acos(l.x),l.y<0&&(i=-i),s=a.z==0?0:a.z>0?Math.PI/2:-Math.PI/2,o=Math.acos(Math.min(Math.max(a.dot(l),-1),1)),this.vecX=this.vecX.rotateZ(-i).rotateX(-s).rotateZ(-o),this.vecX=this.vecX.rotateX(r),this.vecX=this.vecX.rotateZ(o).rotateX(s).rotateZ(i),this.vecY=this.vecY.rotateZ(-i).rotateX(-s).rotateZ(-o),this.vecY=this.vecY.rotateX(r),this.vecY=this.vecY.rotateZ(o).rotateX(s).rotateZ(i),this.vecX.normalize(),this.vecY.normalize()}Stabilize(){let e=new G(this.vecX.x,this.vecX.y,0);Math.abs(this.vecX.z)<=e.size()?this.vecX=e.normalize():this.vecX=new G(0,0,this.vecX.z>0?1:-1),e=new G(this.vecY.x,this.vecY.y,0),Math.abs(this.vecY.z)<=e.size()&&Math.abs(e.dot(this.vecX))<.01||this.vecX.z!=0?this.vecY=e.normalize():this.vecY=new G(0,0,this.vecY.z>0?1:-1)}AddImpact(e,r){const i=this.getRandomFaceIndex(),s=this.getFaceOrientation(i);this.vecX=s[0],this.vecY=s[1],e?this.physicsData.vz=Dt(2,3,Math.random()):this.physicsData.vz=Dt(.5,1,Math.random()),this.physicsData.vy=Math.random()>.5?Dt(-10,-50,Math.random()):Dt(10,50,Math.random());let o=Dt(-5,5,Math.random()),a=Dt(-5,5,Math.random());this.physicsData.va=new G(o,a,Math.random()),this.recordedData=[];let l=!1;for(;!l;){this.CalculatePhysics();let c=new $p;if(c.vecX=this.vecX,c.vecY=this.vecY,c.x=this.physicsData.x,c.y=this.physicsData.y,c.z=this.physicsData.z,this.recordedData.push(c),this.physicsData.vx==0&&this.physicsData.vy==0&&this.physicsData.vz==0&&this.physicsData.va.size()<.01){this.randomAngle=0,r==-1&&(r=Is(0,6)),this.needFinalOffset=r==2,this.randomAngle=Dt(-5,5,Math.random());const[u,h]=this.getFaceOrientation(r),f=we.fromOrientationVectors(this.vecX,this.vecY),m=we.fromOrientationVectors(u,h).multiply(f.transpose());for(let g of this.recordedData)g.vecX=m.multiplyVector(g.vecX).normalize(),g.vecY=m.multiplyVector(g.vecY).normalize();this.recordedData.reverse(),l=!0,this.needPlayback=!0}}}UpdateSpriteFace(e,r){const i=new at(e*yn,r*yn,yn,yn);this.texture=new F({source:this.diceTexture.source,frame:i})}CalculatePhysics(){const e=this.vecX.cross(this.vecY);for(let a=-1;a<=1;a+=2)for(let l=-1;l<=1;l+=2)for(let c=-1;c<=1;c+=2){const u=new G(a*this.vecX.x+l*this.vecY.x+c*e.x,a*this.vecX.y+l*this.vecY.y+c*e.y,a*this.vecX.z+l*this.vecY.z+c*e.z);if(this.physicsData.z+u.z<-1){let h=u.cross(new G(0,0,1));h.normalize(),h=h.mul((Math.max(0,-this.physicsData.vz)+Math.max(0,this.physicsData.va.dot(h.mul(-1))))*.5+.1),this.physicsData.va=this.physicsData.va.add(h),this.physicsData.z=-1-u.z}}this.Rotate(this.physicsData.va,this.physicsData.va.size()/10),this.physicsData.z>10&&(this.physicsData.z=10),this.physicsData.z>0&&(this.physicsData.vz-=.16),this.physicsData.x+=this.physicsData.vx,this.physicsData.y+=this.physicsData.vy,this.physicsData.z+=this.physicsData.vz;const r=R.topPos+38+vn,i=R.topPos+38+376-vn,s=R.width/2-340/2+vn,o=R.width/2-340/2+340-vn;this.physicsData.x<s&&(this.physicsData.x=s,this.physicsData.vx<0&&(this.physicsData.vx=-this.physicsData.vx*.5)),this.physicsData.x>o&&(this.physicsData.x=o,this.physicsData.vx>0&&(this.physicsData.vx=-this.physicsData.vx*.5)),this.physicsData.y<r&&(this.physicsData.y=r,this.physicsData.vy<0&&(this.physicsData.vy=-this.physicsData.vy*.5)),this.physicsData.y>i&&(this.physicsData.y=i,this.physicsData.vy>0&&(this.physicsData.vy=-this.physicsData.vy*.5)),this.physicsData.z<=.01&&(this.physicsData.z=0,this.physicsData.vx*=.5,Math.abs(this.physicsData.vx)<.01&&(this.physicsData.vx=0),this.physicsData.vy*=.5,Math.abs(this.physicsData.vy)<.01&&(this.physicsData.vy=0),this.physicsData.vz*=.5,Math.abs(this.physicsData.vz)<.01&&(this.physicsData.vz=0),this.physicsData.va=new G(0,0,0),this.Stabilize()),this.physicsData.oldZ<.5&&this.physicsData.z<.5&&(this.physicsData.z=0),Math.abs(this.physicsData.oldVZ)<.5&&Math.abs(this.physicsData.vz)<.5&&(this.physicsData.vz=0),this.physicsData.z==0&&this.physicsData.oldVAsize<.4&&this.physicsData.va.size()<.4&&(this.physicsData.va=new G(0,0,0),this.Stabilize()),this.physicsData.oldZ=this.physicsData.z,this.physicsData.oldVZ=this.physicsData.vz,this.physicsData.oldVAsize=this.physicsData.va.size()}GetCurrentFace(){return this.spriteX==0&&this.spriteY==6?1:this.spriteX==6&&this.spriteY==6?2:this.spriteX==0&&this.spriteY==12?3:this.spriteX==0&&this.spriteY==0?4:this.spriteX==18&&this.spriteY==6?5:this.spriteX==12&&this.spriteY==6?6:-1}CalculateSpriteFaceAndAngle(){let e=0,r,i,s,o,a,l,c;r=Math.asin(this.vecY.z)*180/Math.PI,a=new G(this.vecY.x,this.vecY.y,0),a.normalize(),s=Math.acos(a.y)*180/Math.PI,a.x>0&&(s=-s),c=a.y,l=Math.sin(s*Math.PI/180),o=new G(this.vecX.x*c+this.vecX.y*l,-this.vecX.x*l+this.vecX.y*c,this.vecX.z),l=this.vecY.z,c=Math.sqrt(1-l*l),o=new G(o.x,o.y*c+o.z*l,-o.y*l+o.z*c),i=Math.acos(o.x)*180/Math.PI,o.z>0&&(i=-i),this.spriteY=Math.round(r/_n)+fe/2,this.spriteX=(Math.round(-(i-180)/_n)+fe)%(fe*2),(this.spriteY==0||this.spriteY==fe)&&(this.spriteX=0),this.spriteY==0&&(e=i),this.spriteY==fe&&(i<0&&(e=180),this.needFinalOffset&&(e-=90)),e-=s,e+=this.randomAngle,this.spriteY!=0&&this.spriteY!=fe&&(e=Math.round(e/_n)*_n),this.angle=e,this.Draw()}Draw(){this.x=this.physicsData.x,this.y=this.physicsData.y,this.physicsData.z>2?(this.scale=xn(this.physicsData.z,2,10,.7,.9),this.shadow.scale=xn(this.physicsData.z,2,10,2,2.6)):(this.scale=xn(this.physicsData.z,0,2,.5,.7),this.shadow.scale=xn(this.physicsData.z,0,2,1.4,2)),this.shadow.x=this.x-this.width+this.physicsData.z*4-4,this.shadow.y=this.y-this.height+this.physicsData.z*4-4,this.zIndex=this.physicsData.z,this.UpdateSpriteFace(this.spriteX,this.spriteY)}SkipPlayback(){if(this.needPlayback&&this.recordedData.length>0){const e=this.recordedData[0];this.vecX=e.vecX,this.vecY=e.vecY,this.physicsData.x=e.x,this.physicsData.y=e.y,this.physicsData.z=e.z,this.CalculateSpriteFaceAndAngle(),this.needPlayback=!1}}Update(){if(this.needPlayback){const e=this.recordedData.pop();e!=null?(this.vecX=e.vecX,this.vecY=e.vecY,this.physicsData.x=e.x,this.physicsData.y=e.y,this.physicsData.z=e.z,this.CalculateSpriteFaceAndAngle()):this.needPlayback=!1}}}class Vp extends Q{constructor(){super();S(this,"boxContainer");S(this,"bg");S(this,"dice");S(this,"dice2");S(this,"dice3");S(this,"randomBtn");S(this,"shake");S(this,"energyText");this.bg=new et({texture:F.from("diceBackground")}),this.bg.scale=.6,this.bg.x=-this.bg.width/2+R.width/2,this.bg.y=R.bottomPos-this.bg.height,this.addChild(this.bg),this.boxContainer=new Q,this.addChild(this.boxContainer),this.bg=new et({texture:F.from("diceBackground")}),this.bg.scale=.6,this.bg.x=-this.bg.width/2+R.width/2,this.bg.y=R.topPos+Xe,this.boxContainer.addChild(this.bg);const e=new et({texture:F.from("wood")});e.scale=.5,e.x=-e.width/2+R.width/2,e.y=R.topPos,e.zIndex=0,this.boxContainer.addChild(e);const r=new $t().rect(R.width/2-340/2,R.topPos+38,340,380).fill("#df6c6c");this.boxContainer.addChild(r),this.bg.mask=r,this.energyText=Se(this.ourEnergyText),this.energyText.x=R.width/2,this.energyText.y=R.topPos+432,this.energyText.style.fontSize=22,this.energyText.anchor.set(.5),this.boxContainer.addChild(this.energyText);let i=F.from("dice"),s=F.from("diceShadow");this.dice=new zr(R.width/2-100,this.bg.y+330,i,s),this.dice2=new zr(R.width/2+100,this.bg.y+330,i,s),this.dice3=new zr(R.width/2,this.bg.y+330,i,s),this.boxContainer.addChild(this.dice.shadow),this.boxContainer.addChild(this.dice2.shadow),this.boxContainer.addChild(this.dice3.shadow),this.boxContainer.addChild(this.dice),this.boxContainer.addChild(this.dice2),this.boxContainer.addChild(this.dice3),this.dice.Draw(),this.dice2.Draw(),this.dice3.Draw();const o=R.topPos+38+382+40;this.randomBtn=new qt({text:"Random",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2-this.randomBtn.width/2,this.randomBtn.y=o+(R.bottomPos-o)/2-this.randomBtn.height*2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(-1)),this.randomBtn=new qt({text:"Sugar",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(R.bottomPos-o)/2-this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(0)),this.randomBtn=new qt({text:"PVP",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2+2,this.randomBtn.y=o+(R.bottomPos-o)/2-this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(1)),this.randomBtn=new qt({text:"Free",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(R.bottomPos-o)/2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(2)),this.randomBtn=new qt({text:"Event",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2+2,this.randomBtn.y=o+(R.bottomPos-o)/2,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(3)),this.randomBtn=new qt({text:"Fight",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2-this.randomBtn.width-2,this.randomBtn.y=o+(R.bottomPos-o)/2+this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(4)),this.randomBtn=new qt({text:"Jackpot",tint:"#9296A0"}),this.randomBtn.scale=2,this.randomBtn.x=R.width/2+2,this.randomBtn.y=o+(R.bottomPos-o)/2+this.randomBtn.height,this.addChild(this.randomBtn),this.randomBtn.on("pointerdown",()=>this.ThrowDiceButtonClick(5))}get ourEnergyText(){return`Energy: ${zf(Ze.data.energy)}/50`}SkipDicePlayback(){this.dice.SkipPlayback(),this.dice2.SkipPlayback(),this.dice3.SkipPlayback()}ThrowDiceButtonClick(e){!this.dice.needPlayback&&!this.dice2.needPlayback&&!this.dice3.needPlayback?qe.ThrowDice(Ze.data)&&this.ThrowDices(e):this.SkipDicePlayback()}ThrowDices(e){let r=!1;Math.random()>.8&&(r=!0),this.dice.AddImpact(r,e),this.dice2.AddImpact(r,e),this.dice3.AddImpact(r,e),this.shake=.2}update(e){this.shake>0&&(this.boxContainer.y=Math.cos(e.lastTime*.01)*20*this.shake,this.shake-=e.deltaTime*.01),this.dice.Update(),this.dice2.Update(),this.dice3.Update(),this.energyText.text=this.ourEnergyText}}const Bn=class Bn extends Q{constructor(){super();S(this,"roomScreen");S(this,"diceScreen");S(this,"backButton");S(this,"timer");S(this,"assetBundles",["diceAsset","uiAsset","background","fonts"]);S(this,"data");this.data=qe.LoadData(),Bn.data=this.data}constructorWithAssets(){this.roomScreen=new Gp,this.addChild(this.roomScreen),this.diceScreen=new Vp,this.addChild(this.diceScreen),this.roomScreen.visible=!1,this.diceScreen.visible=!0,this.backButton=new et({texture:F.from("roomIcon")}),this.backButton.scale=.5,this.backButton.x=R.rightPos-this.backButton.width-10,this.backButton.y=R.bottomPos-this.backButton.height-Xe,this.backButton.eventMode="static",this.backButton.cursor="pointer",this.backButton.on("pointerdown",()=>{this.flipScrens()}),this.addChild(this.backButton)}flipScrens(){this.roomScreen.visible=!this.roomScreen.visible,this.diceScreen.visible=!this.diceScreen.visible}update(e){this.roomScreen.update(e),this.roomScreen.y=0,this.diceScreen.update(e)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),i=Se(e+"x"+r);i.anchor.set(.5),i.x=R.width/2,i.y=R.width/2-10,this.addChild(i);const s=Se(R.enlargedWidth+"x"+R.enlargedHeight);s.anchor.set(.5),s.x=R.width/2,s.y=R.width/2,this.addChild(s);const o=Se(window.Telegram.WebApp.platform);o.anchor.set(.5),o.x=R.width/2,o.y=R.width/2+10,this.addChild(o)}};S(Bn,"data");let Ze=Bn,Wp=750,qa=100;qr.isDesktop&&(qa=0);let si;const Xp=n=>{si=n.touches[0].clientY},Us=document.getElementsByTagName("body")[0],Yp=n=>{if(Us){const t=Us.scrollTop,e=n.changedTouches[0].clientY;t<=0&&si!==void 0&&si<e,n.preventDefault()}};document.documentElement.addEventListener("touchstart",Xp,{passive:!1});document.documentElement.addEventListener("touchmove",Yp,{passive:!1});(async()=>(await R.Init(550,Wp,1,qa),await R.ChangeScene(new Ze)))();export{Z as $,Ao as A,rt as B,Q as C,lt as D,D as E,$ as F,L as G,At as H,Ni as I,et as J,uu as K,_u as L,H as M,it as N,at as O,ut as P,Du as Q,Un as R,vu as S,an as T,go as U,Wi as V,Ll as W,rr as X,j as Y,Hs as Z,U as _,Ur as a,Fo as a0,Te as a1,hh as a2,Vo as a3,Hh as a4,jh as a5,ze as a6,ft as a7,na as a8,qh as a9,ko as aa,he as ab,Vh as ac,ae as ad,Tt as ae,Yi as af,$t as ag,ml as ah,Do as ai,Pt as b,N as c,ci as d,gt as e,fs as f,Tc as g,Mc as h,lr as i,Nt as j,Sn as k,ui as l,Io as m,Fi as n,So as o,ro as p,zt as q,Al as r,F as s,dl as t,Fc as u,Ac as v,ct as w,Ot as x,Xs as y,pt as z};
