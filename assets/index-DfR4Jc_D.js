...
`;let Ie=null,er=class{constructor(){Ie||(Ie=URL.createObjectURL(new Blob([Mc],{type:"application/javascript"}))),this.worker=new Worker(Ie)}};er.revokeObjectURL=function(){Ie&&(URL.revokeObjectURL(Ie),Ie=null)};const Fc=`(function () {
    'use strict';
...
fn unmapCoord(coord: vec2<f32> ) -> vec2<f32>
{
    ...
    mappedCoord /= gfu.uInputSize.xy;
    return mappedCoord;
}`,Sd=Object.defineProperty,Cd=(n,t,e)=>t in n?Sd(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,ir=(n,t,e)=>(Cd(n,typeof t!="symbol"?t+"":t,e),e);const wd=class Pa extends ${constructor(...t){let e=t[0]??{};typeof e=="number"&&(k("6.0.0","AsciiFilter constructor params are now options object. See params: { size, color, replaceColor }"),e={size:e});const i=(e==null?void 0:e.color)&&e.replaceColor!==!1;e={...Pa.DEFAULT_OPTIONS,...e};const r=D.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:bd,entryPoint:"mainFragment"}}),s=G.from({vertex:H,fragment:_d,name:"ascii-filter"});super({gpuProgram:r,glProgram:s,resources:{asciiUniforms:{uSize:{value:e.size,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uReplaceColor:{value:Number(i),type:"f32"}}}}),ir(this,"uniforms"),ir(this,"_color"),this.uniforms=this.resources.asciiUniforms.uniforms,this._color=new Y,this.color=e.color??16777215}get size(){return this.uniforms.uSize}set size(t){this.uniforms.uSize=t}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,i,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=i,this.uniforms.uColor[2]=r}get replaceColor(){return this.uniforms.uReplaceColor>.5}set replaceColor(t){this.uniforms.uReplaceColor=t?1:0}};ir(wd,"DEFAULT_OPTIONS",{size:8,color:16777215,replaceColor:!1});var Pd=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,op=Object.defineProperty,ap=(n,t,e)=>t in n?op(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,rr=(n,t,e)=>(ap(n,typeof t!="symbol"?t+"":t,e),e);const lp=class za extends ${constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(k("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...za.DEFAULT_OPTIONS,...e};const i=D.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:sp,entryPoint:"mainFragment"}}),r=G.from({vertex:H,fragment:rp,name:"color-overlay-filter"});super({gpuProgram:i,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),rr(this,"uniforms"),rr(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new Y,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,i,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=i,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};rr(lp,"DEFAULT_OPTIONS",{color:0,alpha:1});var up=`in vec2 vTextureCoord;
out vec4 finalColor;
